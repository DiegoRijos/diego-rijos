...
```{r renta variable, echo=FALSE, fig.height=5, fig.width=8}
...
```{r fideicomisos constituidos, echo=FALSE, fig.height=5, fig.width=8}
...
```{r on, echo=FALSE, fig.height=5, fig.width=8}
